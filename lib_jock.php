...
class lib_jock{
    ...
    // INSERT INTO `JOCK` (`id`, `username`, `password`, `Date`) VALUES (NULL, 'username', 'password', 'Date ')
    public function insert($QU){
        $qr = "INSERT INTO `".JOCK."` (`id`, `QU`) VALUES (NULL, '$QU');";
        $result = $this->query($qr);
        return $result;
    }

    public function select($id){
        $qr = "SELECT `QU` FROM `".JOCK."` WHERE id = '$id'";
        $result = $this->query($qr);
    ...
    public function delete($id){
        $qr = "DELETE FROM `".JOCK."` WHERE id = '$id'";
        $result = $this->query($qr);
        $row = mysqli_fetch_array($result);
        return $row;
    }    
    ...
    public function update($id,$QU){
        $qr = "UPDATE `".JOCK."` SET `QU`='$QU' WHERE `id`='$id'";
        $result = $this->query($qr);
        $row = mysqli_fetch_array($result);
        return $row;
    }
